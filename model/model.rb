...
module Model
    ...
    #
    # @params [Integer] id The user_id of the user
    #
    # @return [Hash]
    ...
    # @param [Integer] id The user_id of the user
    # @param [Integer] time The time spent on activity
    # @param [Hash] The milestones user already has unlocked
    ...
    #
    # param [Float] date the miliseconds since 1st of January 1970 to user's birthday
    # param [Integer] id The user_id of the user
